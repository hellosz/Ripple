...
class UserSkillCopy(Base):
    __tablename__ = "user_skill_copies"
    __table_args__ = (UniqueConstraint("user_id", "skill_id", name="uq_user_skill_copy"),)
    ...
    skill = relationship("Skill", back_populates="copies")
