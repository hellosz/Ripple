...
## 2. renderer
- [x] 2.1 连接卡登录态重构 + Logo 布局修正 + 未登录置灰
- [x] 2.2 Agent logo 按调研结果替换（agent-icons.tsx）
- [x] 2.3 仅项目视图按项目分组折叠
- [x] 2.4 列表头 Agent 批量复制/取消复制（确认弹窗）
- [x] 2.5 技能行 v3 布局 + 本地 Skill 详情（文件树/内容/编辑保存）
- [x] 2.6 市场卡片安装态进度条 + 市场 Skill 详情弹窗
- [x] 2.7 全绿（tsc/lint/build）并打包
